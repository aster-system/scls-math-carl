...
namespace scls {
    ...
    public:
        ...
        double max_absolute_z() const;
        double min_absolute_x() const;
        double min_absolute_y() const;
        double min_absolute_z() const;
        ...
        inline void set_velocity(Point_3D new_velocity){a_velocity = new_velocity;};
        ...
        inline Point_3D absolute_rotation() const {return Point_3D(absolute_rotation_x(), absolute_rotation_y(), absolute_rotation_z());};
