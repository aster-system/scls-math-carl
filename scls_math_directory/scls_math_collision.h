...
namespace scls {
    ...
    public:
        ...
        struct Collision_Event {
            ...
            Collision_Event* other_collision(){return a_other_collision.lock().get();};
            void set_other_collision(std::weak_ptr<Collision_Event> new_other_collision){a_other_collision = new_other_collision;};
        ...
        private:
            ...
            std::weak_ptr<Collision_Event> a_other_collision;
        };

        // Collision constructor
        Collision(std::weak_ptr<scls::Transform_Object_2D> attached_transform):a_attached_transform(attached_transform){};
    ...
    private:
        ...
        Collision_Type a_type = Collision_Type::GCT_Rect;
    ...
    public:
        ...
        std::shared_ptr<Graphic_Physic> new_physic_object();
        ...
        // Raycasts the map
        struct Raycast_Result{std::shared_ptr<Collision::Collision_Event> collision;};
