...
namespace scls {
    ...
    public:
        ...
        // Getters
        inline double angular_momentum() const {return a_angular_momentum;}
        inline double rotation() const {return a_rotation;};
        inline void set_angular_momentum(double new_angular_momentum){a_angular_momentum = new_angular_momentum;};
