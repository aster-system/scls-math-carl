...
//
// This file contains some tools to use 2D physic in SCLS.
//
//******************
//
// License (LGPL V3.0) :
...
namespace scls {
    ...
    public:
        ...
        public:
            ...
            struct Collision_Event {
                ...
                Physic_Object* attached_physic(){return a_collision_parent.lock().get()->attached_physic();};
                ...
                Physic_Object* other_physic(){return a_other_collision.lock().get()->attached_physic();};
                ...
                Point_2D a_collision_position;
                void set_collision_position(Point_2D new_position){a_collision_position = new_position;};
            ...
            // Collision constructor
            Collision(std::weak_ptr<Physic_Object> attached_physic, std::weak_ptr<scls::Transform_Object_2D> attached_transform):a_attached_physic(attached_physic),a_attached_transform(attached_transform){};
            ...
            Physic_Object* attached_physic()const;
        ...
        private:
            // Attached physic
            std::weak_ptr<Physic_Object> a_attached_physic;
            // Attached object
        ...
        struct Physic_Case{
            ...
            std::vector<std::weak_ptr<Physic_Object>> static_objects_collisions_physic;
        ...
        // Apply a force
        void apply_force(Point_2D force);
        void apply_force(Point_2D force, Point_2D base);
        ...
        inline double next_rotation()const{return a_attached_transform.lock().get()->next_rotation();};
        ...
        void __rotate(){scls::Transform_Object_2D* t=a_attached_transform.lock().get();t->rotate(next_rotation());};
        ...
        inline void set_this_object(std::weak_ptr<Physic_Object> this_object) {a_this_object = this_object;}
    ...
    typedef Physic_Object::Collision Collision;
    typedef Physic_Object::Physic_Case Physic_Case;
    ...
    public:
        ...
        void check_delete_physic_object();
        // Deletes the physic in a case
        void delete_physic_object_case(Physic_Object* to_delete);
        ...
        std::shared_ptr<Physic_Object> new_physic_object(std::weak_ptr<Transform_Object_2D> object);
        // Returns a physic case by its coordinates
        Physic_Case* physic_case(int x, int y);
        // Returns a list of physic object in a rectr
        std::vector<std::shared_ptr<Physic_Object>> physic_objects_in_rect(double x, double y, double width, double height);
