...
namespace scls {
    ...
    enum Collision_Type_3D {CT_3D_Sphere, CT_3D_Line, CT_3D_Cube, CT_3D_Face};
    ...
    public:
        ...
        inline void accelerate(Point_3D acceleration){a_attached_transform.lock().get()->accelerate(acceleration);};
        ...
        // Accelerates the object absolutely
        inline void accelerate_absolute(Point_3D acceleration){a_attached_transform.lock().get()->accelerate_absolute(acceleration);};
        // Apply a fore on the object
        void apply_force(Point_3D needed_force);
        void apply_force_absolute(Point_3D needed_force);
